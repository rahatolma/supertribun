...
const Privacy = () => <>
  ...
  <section><h2>2. Hangi bilgiler, hangi amaçlarla işlenir?</h2>
    <ul>
      ...
      <li><strong>Ziyaret ölçümü:</strong> Vercel Web Analytics ile anonim ve toplu sayfa/tıklama istatistikleri değerlendirilir. Paylaşım kimliği, hesap bilgisi veya tahmin sahibinin kimliği ölçüme gönderilmez. Buton tıklaması uygulamanın indirildiği anlamına gelmez.</li>
...
const Cookies = () => <>
  ...
  <section><h2>2. Siteye eklediğimiz araçlar</h2>
    <div className="legal-inventory">
      ...
      <article><h3>Ziyaret ve tıklama ölçümü</h3><dl><dt>Sağlayıcı</dt><dd>Vercel Web Analytics</dd><dt>Kapsam</dt><dd>Paylaşım sayfalarında çerezsiz, anonim ve toplu ölçüm; tanıtım önizlemesindeki isteğe bağlı ölçüm ayrıca kullanıcı tercihine bağlıdır.</dd><dt>Amaç</dt><dd>Site kullanımı ile paylaşılan tahmin sayfasındaki “Uygulamada aç” düğmesine ilgiyi ölçmek. Düğmeye basılması indirme değildir.</dd><dt>Teknoloji / süre</dt><dd>Çerez kullanılmaz. Paylaşım kimliği, sorgu değeri, hesap bilgisi ve tahmin sahibinin kimliği ölçüm adresine veya olay özelliklerine gönderilmez. Sağlayıcı raporlarının saklama süresi yayın kontrolünde ayrıca doğrulanacaktır.</dd></dl></article>
