...
export default async function handler(request,response){
  ...
  try{
    const data=await fetchShareData(id),origin='https://supertribun.com',canonical=`${origin}/t/${id}`,image=`${origin}/api/share-image?id=${id}&v=5`;
...
</style></head><body><main class="page"><div class="wrap"><img class="brand" src="/logo.png" alt="SüperTribün"><img class="card" src="${image}" width="1200" height="630" alt="${escape(title)} kilitli tahmin kartı"><div class="actions"><a id="open-app" class="button" href="com.supertribun.app://t/${id}">Uygulamada aç</a><a class="button secondary" href="/">SüperTribün'ü keşfet</a></div><p class="foot"><a href="/gizlilik">Gizlilik</a></p></div></main><script>
